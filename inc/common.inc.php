		...
		if($DB->numRows){						
			if($level)
				...
				foreach($DB->rows as $v) {
					...
					if( strtolower( $v["menuTitle"] ) == 'nu games' )
						$str .= '<li class="'.$v["menuClass"].'"><a'.$class.' href="'.$url.'"'.$target.'><span class="ghover" >' . $v["menuTitle"] . '</span></a>';
					else if( strtolower( $v["menuTitle"] ) == 'nu cards' )
						$str .= '<li class="'.$v["menuClass"].'"><a'.$class.' href="'.$url.'"'.$target.'><span class="chover" >' . $v["menuTitle"] . '</span></a>';	
					else
