<?php
	...
	********************************************/
	...
	//'------------------------------------
	// $API_UserName="vivekkumar.trivedi-facilitator_api1.gmail.com";
	// $API_Password="1365404785";
	// $API_Signature="AS02KC5H98DfygIYrz2gy7Vd25e-AmMwHRB8XI8lIZvsB0W6MlRxVrC8";

	$API_UserName="nuplayingcards_api1.gmail.com";
	$API_Password="2K3TRELFVADVBTHS";
	$API_Signature="AFcWxV21C7fd0v3bYYYRCpSSRl31Af-9pcqmgptaGcnEIWXEQSRBOhPu";
	...
	*/
	function ConfirmPayment( $token, $paymentType, $currencyCodeType, $payerID, $FinalPaymentAmt )
	{
		...
		$nvpstr .= '&PAYMENTREQUEST_0_CURRENCYCODE=' . $currencyCodeType . '&PAYMENTREQUEST_0_ITEMAMT=' . $FinalPaymentAmt . '&L_PAYMENTREQUEST_0_AMT0=' . $FinalPaymentAmt . '&IPADDRESS=' . $serverName. '&L_PAYMENTREQUEST_0_ITEMCATEGORY0=Digital'; 
